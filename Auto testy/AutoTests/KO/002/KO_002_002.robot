...
Testing - #KO_002_002
    ...
    Click Button    //button[@data-testid='increase']
    Wait Until Element Is Visible    //span[@data-testid='notifierMessage' and contains(text(), 'Množství bylo úspěšně změněno.')]
    
    ## ----------------------------------------    Expected result:
    Element Should Be Visible    //span[@data-testid='notifierMessage' and contains(text(), 'Množství bylo úspěšně změněno.')]
    ${amount}=    Get Element Attribute    //input[@data-testid='cartAmount']    value
    Should Be True   ${amount}    2

Post-condition - #KO_002_002
    Close Browser
