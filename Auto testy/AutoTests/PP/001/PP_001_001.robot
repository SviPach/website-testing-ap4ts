...
Testing - #PP_001_001
    ## ----------------------------------------    Pointing mouse at the main image:
    Mouse Down    //div[contains(@style, 'R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7')]

    ## ----------------------------------------    Expected result:
    Element Should Be Visible    //div[@id='cloud-zoom-big']

Post-condition - #PP_001_001
    Close Browser
