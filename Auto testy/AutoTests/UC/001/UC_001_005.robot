...
Testing - #UC_001_005
    ...
    Input Text    //input[@type='password']    1234
    ...
    ## ----------------------------------------    Expected result:
    Element Should Be Visible    //span[@data-testid='notifierMessage' and contains(text(), "Neplatné přihlášení")]

Post-condition - #UC_001_005
    Close Browser
