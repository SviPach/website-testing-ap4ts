...
Testing - #UC_002_001
    ...
    Click Link    //a[@href='/klient/objednavky/']

    ## ----------------------------------------    Expected result:
    Location Should Be    https://www.lokni-shop.cz/klient/objednavky/
    Page Should Contain    Ještě jste žádnou objednávku nevytvořil....

Post-condition - #UC_002_001
    Close Browser