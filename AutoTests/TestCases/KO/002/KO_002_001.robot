...
Testing - #KO_002_001
    ...
    ## ----------------------------------------    Checking if product was added and removing it:
    ...
    Element Should Not Be Visible    //tr[@data-testid='productItem_6542e0e2-0e30-11f0-ae65-8ee2ab6e4ccb']

Post-condition - #KO_002_001
    Close Browser
