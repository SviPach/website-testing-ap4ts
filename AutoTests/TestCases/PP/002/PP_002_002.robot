...
Pre-condition - #PP_002_002
    ...
    Wait Until Element Is Visible    //p[@data-testid='productCardDescr']/a[@href='#description']


Testing - #PP_002_002
     ## ----------------------------------------    Going to the description tab:
    Click Element    //p[@data-testid='productCardDescr']/a[@href='#description']
