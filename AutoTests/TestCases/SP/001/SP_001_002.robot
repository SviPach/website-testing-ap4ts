...
Testing - #SP_001_002
    ...
    Click Element    //label[@for='order3']
    ...
    FOR    ${product}    IN    @{products_list}
        ...
        ## ----------------------------------------    Expected result:
        Should Be True    ${num1} < ${num2}    msg=First number must be less than the second one!
