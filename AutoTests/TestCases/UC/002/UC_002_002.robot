...
Testing - #UC_002_002
    ...
    Click Link    //a[@href='/klient/klient-doklady/']
    
    ## ----------------------------------------    Expected result:
    Location Should Be    https://www.lokni-shop.cz/klient/klient-doklady/
    Page Should Contain    Ještě pro vás nebyl vytvořen žádný dokument.

Post-condition - #UC_002_002
    Close Browser