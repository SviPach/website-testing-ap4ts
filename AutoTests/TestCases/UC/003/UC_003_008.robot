...
Testing - #UC_003_008
    ...
    ## ----------------------------------------    Checking if new delivery address is added:
    ...
    ## ----------------------------------------    Changing the new delivery address:
    Click Link    (//tbody/tr/td)[7]/a
    Wait Until Element Is Visible    //input[@id='deliveryFullName']
    Input Text    //input[@id='deliveryFullName']    ${name_3}
    Click Element    //input[@type='submit']
    Wait Until Location Is    https://www.lokni-shop.cz/klient/nastaveni/
    ...
    Should Be Equal    ${count}    1    msg=Has to be 1!
    ${name_result}=    Get Text    (//tbody/tr/td)[1]
    Should Be Equal    ${name_result}    ${name_3}

Post-condition - #UC_003_008
    ## ----------------------------------------    Deleting the new added delivery address:
    ...
    ## ----------------------------------------    Checking if new delivery address is deleted:
    Element Should Be Visible
